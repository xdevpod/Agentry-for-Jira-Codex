 ...
 *   /Users/yinliang/Workspace/AI/Agents-Cowork-with-Jira → -Users-yinliang-Workspace-AI-Agents-Cowork-with-Jira
 *
...
function projectLabel(s) {
  ...
  // Fallback: encoded key (e.g. -Users-x-Workspace-Agents-Cowork-with-Jira) — show as-is
